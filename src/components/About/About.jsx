    ...
    <div className={styles.row}>
      <div className={styles.left_column}>
        <div className={styles.text}>
          ...
          <br/>
          <Typography>
          I am actively seeking internship opportunities for <b>Summer 2021</b>. Feel free to explore the rest of my website, and please reach out to me if interested!
          </Typography>
          <br/>
          <Divider/>
          <br/>
