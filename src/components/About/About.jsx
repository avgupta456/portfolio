    ...
    <div className={styles.row}>
      <div className={styles.left_column}>
        <div className={styles.text}>
          ...
          My name is Abhijit Gupta, and I am a junior at Yale University, pursuing a double major in Computer Science and Applied Mathematics.
          ...
          I am a developer for the Yale Computer Society, and help organize YHack, Yale’s largest annual hackathon.
          This past summer, I interned at RTI International as a data warehouse intern, working on ___.
          In my free time, I enjoy dancing and rock climbing.
          </Typography>
          <br/>
          <Typography>
